...
example: build
	...
	$(BIN) generate --format gif --output examples/ariel-why-output.gif examples/ariel-why.ariel.yaml
	# ariel-what has multiple sections — SVG format not supported for multi-section.
	...
	$(BIN) generate --format gif --output examples/ariel-what-output.gif examples/ariel-what.ariel.yaml
