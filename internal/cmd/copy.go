...
and display narration text — rendered as self-contained HTML (interactive), MP4, GIF, or SVG (for embedding in GitHub READMEs and PR summaries as a clickable walkthrough).`
...
const generateShort = "Render a walkthrough file to HTML, MP4, GIF, or SVG"
const generateFlagOutputHelp = "output path (default: input path with format extension)"
const generateFlagFormatHelp = "output format: html, mp4, gif, or svg"
